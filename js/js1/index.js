        ...
        series: [
            {
                ...
                type: 'bar',
                barWidth: '35%',
                data: [200, 300, 300, 900, 1500, 1200, 600],//ajax调用后端数据，实时变化
                itemStyle: {
                    // 修改柱子圆角
                    barBorderRadius: 5
                }
...
(function(){
    ...
    option = {
        ...
        legend: {
            ...
            right: "10%",//距离右边框10%
            //data: ['邮件营销', '联盟广告', '视频广告', '直接访问', '搜索引擎']  如果series 的对象右name值，则legend可以不用写data
        },
        grid: { 
            top: '20%',
            left: '3%',
